...
Это исторический снимок состояния после ошибочного удаления обязательных
каналов AC2–AC10. Всего сущностей в снимке: **83**. Текущее состояние и причина
восстановления описаны в
[спецификации кондиционера](../specs/office-air-conditioner.md).
