...
CO2-автоматика реализована сценарием Larnitech `315:245`; ручное управление
выполняется через область `VAKIO` в Larnitech. Прямой HTTP endpoint шлюза при
активном мосте запрещён.
